...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'Instagram', icon: Instagram, href: 'https://instagram.com/altronix.rknec' },
    { name: 'LinkedIn', icon: Linkedin, href: 'https://linkedin.com/company/altronix-rknec' },
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <div>
                <p className="text-sm">
                  ...
                  <span className="block mt-1"><a href="https://www.linkedin.com/company/aiml-rcoem/">LinkedIn: ALTRONIX</a></span>
                  <span className="block mt-1"><a href="https://www.instagram.com/aiml_rbu/">Instagram: @aiml_rbu</a></span>
                  <span className="block mt-2"> 53G6+GCJ, 15, Gittikhadan Rd, Nehru Colony, BUPESHNAGAR, Nagpur, Maharashtra 440013</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4">
              <p className="text-muted-foreground text-sm">
                © 2025 Altronix. All rights reserved.
              </p>
