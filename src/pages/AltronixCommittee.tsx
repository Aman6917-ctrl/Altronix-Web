...
const AltronixCommittee = () => {
  ...
  const committeeMembers: CommitteeMember[] = [
    // 4th Year Members
    { name: "Akshay Chandak", post: "President", photo: "/placeholder.svg", year: "4th Year" },
    { name: "Divya Ruthiya", post: "Vice President", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Arya Asutkar", post: "Secretary", photo: "/placeholder.svg", year: "4th Year" },
    { name: "Shanmukh Pardhi", post: "Treasurer", photo: "/placeholder.svg", year: "4th Year" },
    ...
    { name: "Mrunal Parashar", post: "Cultural Secretary", photo: "/placeholder.svg", year: "4th Year" },
    { name: "Nitya Joshi", post: "Cultural Secretary", photo: "/placeholder.svg", year: "4th Year" },
    { name: "Anish Patankar", post: "Sports Secretary", photo: "/placeholder.svg", year: "4th Year" },
    { name: "Aman Patne", post: "Sports Secretary", photo: "/placeholder.svg", year: "4th Year" },
    { name: "Pragati Borkar", post: "Event Manager", photo: "/placeholder.svg", year: "4th Year" },
    { name: "Sumedh Khangan", post: "Event Manager", photo: "/placeholder.svg", year: "4th Year" },
    { name: "Saket Karwa", post: "Event Manager", photo: "/placeholder.svg", year: "4th Year" },
    ...
    { name: "Sanskruti Shukla", post: "Joint Secretary", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Sumedh Pittule", post: "Joint Treasurer", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Palak Zade", post: "Joint Cultural Secretary", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Janhavi Naidu", post: "Joint Cultural Secretary", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Shrushti Ghiya", post: "Joint Sports Secretary", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Yash Chaudhari", post: "Joint Sports Secretary", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Soham Choudhari", post: "Joint Event Manager", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Sujal Sanat Pandey", post: "Joint Event Manager", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Vaishnavi Lilhare", post: "Creative Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Himanshu Khobragade", post: "Creative Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Chaitali Nadekar", post: "Creative Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Suhani Paliwal", post: "Publicity Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Vedant Umap", post: "Publicity Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Aditi Gupta", post: "Publicity Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Viraj Yawle", post: "Media Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Anjali Jaikalyani", post: "Media Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Roshni Chawla", post: "Media Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Ankit Lanjewar", post: "Venue and Resource Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Anshum Pal", post: "Venue and Resource Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Anurag Pathak", post: "Photography and Videography Lead", photo: "/placeholder.svg", year: "3rd Year" },
    { name: "Chitresh Deshmukh", post: "Photography & Videography", photo: "/placeholder.svg", year: "3rd Year" }
  ];
